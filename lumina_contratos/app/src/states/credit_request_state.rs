...
// Estructura para almacenar los datos de solicitudes de crédito con colateral
#[derive(Clone, Default)]
pub struct CreditRequestState {
    pub all_requests: HashMap<ActorId, (u32, u32, Purpose, TimeToPay)>,
}
...
// Estructura estado con colateral
